/*Implement a WAL system for a simple file-based key-value
store. Each write operation (insert/update/delete) should
append a log entry with a timestamp and operation type.
*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
